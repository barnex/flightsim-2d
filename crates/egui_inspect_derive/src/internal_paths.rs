...
pub(crate) fn try_handle_internal_path(field: &Field, mutable: bool, attrs: &AttributeArgs) -> Option<TokenStream> {
	...
	match path_str.as_str() {
		"f64" | "f32" | "u8" | "i8" | "u16" | "i16" | "u32" | "i32" | "u64" | "i64" => handle_number_path(field, mutable, attrs),
